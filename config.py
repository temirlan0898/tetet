...
# Telegram group settings (new addition)
TELEGRAM_GROUP_ID = os.getenv("TELEGRAM_GROUP_ID")  # ID вашей группы Telegram
...
BLOCKED_CHAT_IDS = [ 
    # Список заблокированных пользователей (если есть)
]
